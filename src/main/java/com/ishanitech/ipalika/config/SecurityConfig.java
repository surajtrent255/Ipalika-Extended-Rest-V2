...
//			.antMatchers("/**").permitAll()
				.antMatchers(HttpMethod.GET, "/favourite-place/**", "/e-governance/**", "/lg/**").permitAll()
				.antMatchers(HttpMethod.POST, "/e-governance/**").permitAll()
				.antMatchers(HttpMethod.PUT, "/e-governance/**").permitAll()
