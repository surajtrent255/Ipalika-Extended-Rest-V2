...
public class UserServiceImpl implements UserService {
	...
	public User getUserById(int userId) {
		...
		try {
			...
			user.setStamp(ImageUtilService.makeFullImageurl(restUrlProperty, user.getStamp()));
			user.setSignature(ImageUtilService.makeFullImageurl(restUrlProperty, user.getSignature()));
