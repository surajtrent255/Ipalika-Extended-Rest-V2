...
public class AdvertisementTaxServiceImpl implements AdvertisementTaxService {
    ...
    @Override
    public void addAdvertisementRegistration(List<AdvertisementTaxDTO> advertisementRegistrationInfo) {
        try {
...
//    = (List<AdvertisementTaxDTO>) new AdvertisementTaxDTO() error class java loader
    ...
    @Override
    public void updateAdvertisementCertificateByTokenId(List<AdvertisementTaxDTO> advertisementRegistrationInfo, String tokenId) {
        try {
